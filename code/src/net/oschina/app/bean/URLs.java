...
public class URLs implements Serializable {
	...
	//@hu 此处添加本地调试网址
	public final static String HOST_LOCAL_DEBUG = "10.0.2.2:8080/dmgweb";
	public final static String HTTP_LOCAL_DEBUG = "http://";
	public final static String HTTPS_LOCAL_DEBUG = "https://";
	private final static String URL_SPLITTER_LOCAL_DEBUG = "/";
	private final static String URL_UNDERLINE_LOCAL_DEBUG = "_";
	private final static String URL_API_HOST_LOCAL_DEBUG = HTTP_LOCAL_DEBUG + HOST_LOCAL_DEBUG + URL_SPLITTER_LOCAL_DEBUG;
	//@hu 此处添加本地调试网址
	...
	public final static String NEWS_LIST = URL_API_HOST_LOCAL_DEBUG+"action/api/news_list";
